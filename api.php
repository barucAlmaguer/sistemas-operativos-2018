...
$hk_url = parse_url(getenv("CLEARDB_DATABASE_URL"));

$hk_server = $hk_url["host"];
$hk_username = $hk_url["user"];
$hk_password = $hk_url["pass"];
$hk_db = substr($hk_url["path"], 1);

$api = new PHP_CRUD_API(array(
	'dbengine' => 'MySQL',
	'hostname' => $hk_server,
	'username' => $hk_username,
